...
import com.chen.yygh.repository.ScheduleRepository;
...
import com.chen.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        if(ObjectUtil.isNotNull(exist)) {
            ...
            BeanUtil.copyProperties(schedule,exist, CopyOptions.create(Schedule.class,true));
    ...
    private void packageSchedule(Schedule schedule) {
        ...
        //设置科室名称
        schedule.getParam().put("depname",departmentRepository.getDepartmentByHoscodeAndDepcode(schedule.getHoscode(),schedule.getDepcode()).getDepname());
        //设置日期对应星期
